...
const DEFAULT_IMAGES: GalleryImage[] = [
  { src: '/1.png', alt: 'WanderTrails Explorer 1' },
  { src: '/2.png', alt: 'WanderTrails Explorer 2' },
  { src: '/3.png', alt: 'WanderTrails Explorer 3' },
  { src: '/4.png', alt: 'WanderTrails Explorer 4' },
  { src: '/5.png', alt: 'WanderTrails Explorer 5' },
  { src: '/6.png', alt: 'WanderTrails Explorer 6' }
];
...
interface GalleryItem extends GridCoord {
  src: string;
  alt: string;
}

function buildItems(pool: (string | GalleryImage)[], seg: number): GalleryItem[] {
